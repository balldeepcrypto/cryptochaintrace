    ...
    <div style={{ minHeight: "100vh", background: "#080d1a", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", fontFamily: "ui-monospace, SFMono-Regular, 'Cascadia Code', monospace", padding: 24, position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ width: "100%", maxWidth: 460, position: "relative", zIndex: 1 }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 32 }}>
          ...
          <h1 style={{ color: "#f1f5f9", fontSize: "1.5rem", fontWeight: 700, letterSpacing: "0.01em", margin: "0 0 10px", lineHeight: 1.25 }}>
            Law Enforcement &amp; Analyst Portal
          </h1>
          <div style={{ color: "#22d3ee", fontSize: "0.7rem", letterSpacing: "0.18em", textTransform: "uppercase", fontWeight: 500 }}>
